...
<div id="wrapper">
        ...
        <div class="container">
            <nav>
                <ul id="main-menu" class="d-flex">
                    ...
                    <li class="acc"><a style="color:#23282E;" href="">Service</a></li>
    ...
    <div id="wp-featured-post">
        ...
        <div class="container justify-content-between">
            ...
            <div class="box featured-post">
                <div class="box-head">
                    <a href="/services?action=create" class="create" style="padding: 5px 10px;
                    background: #FF2C2B;
                    font-size: 20px;
                      color: white;
            ...
            <div class=" pt-20" style="width: 100%; ">
                <table class="table table-striped table-bordered" style="width: 100%;" id="tableEmployee">
                    ...
                    <tr style="background-color: #FF2C2B;">
                        ...
                        <th>Max people</th>
                        <th>Standard room</th>
                        <th>Description other conveniece</th>
                        <th>Pool area</th>
                    ...
                    <c:forEach items="${serviceList}" var="s">
                        <tr>
                            ...
                            <td>${s.getServiceArea()}</td>
                            <td>${s.getServiceCost()}</td>
                            <td>${s.getServiceMaxPeople()}</td>
                            <td>${s.getStandardRoom()}</td>
                            <td>${s.getDescriptionOtherConveniece()}</td>
                            <td>${s.getPoolArea()}</td>
                            <td>${s.getNumberOfFloors()}</td>
...
<%--                            </c:forEach>--%>
                            <td>
                                <a class="btn btn-primary" href="/employees?action=edit&id=${s.getServiceId()}"
                                   style="margin-bottom:10px "><i class="fa-solid fa-pen-to-square"></i></a>
                                <button type="button"
                                        onclick="getNameId('${s.getServiceId()}','${s.getServiceName()}')"
