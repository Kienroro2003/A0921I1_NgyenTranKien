...
<div id="wp-featured-post">
    ...
    <div class="container justify-content-between">
        ...
        <div class="box featured-post">
            <div class="box-head">
                <a href="/employees" class="create" style="padding: 5px 10px;
                    background: #FF2C2B;
                    font-size: 20px;
                      color: white;
        ...
        <div class=" pt-20" style="width: 100%; ">
            ...
            <form action="/employees?action=create" method="post">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="name" id="name" placeholder="Enter name" value="${employee.getEmployeeName()}">
                    <span style="color: red;">${stringList[0]}</span>
                </div>
                <div class="mb-3 w-50">
                    <label for="birthday" class="form-label">Birthday: </label>
                    <input type="date" id="birthday" class="form-control" name="birthday" value="${employee.getEmployeeBirthday()}">

                </div>
                <div class="mb-3">
                    <label for="idCard" class="form-label">Id card</label>
                    <input type="text" class="form-control" name="idCard" id="idCard" placeholder="Enter id card" value="${employee.getEmployeeIdCard()}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="phone" id="phone" placeholder="Enter phone" value="${employee.getEmployeePhone()}">
                    <span style="color: red;">${stringList[3]}</span>
                </div>
                <div class="mb-3">
                    <label for="email" class="form-label">Email</label>
                    <input type="email" class="form-control" name="email" id="email" placeholder="Enter email" value="${employee.getEmployeeEmail()}">
                    <span style="color: red;">${stringList[4]}</span>
                </div>
                <div class="mb-3">
                    <label for="address" class="form-label">Address</label>
                    <input type="text" class="form-control" name="address" id="address" placeholder="Enter address" value="${employee.getEmployeeAddress()}">
                </div>
                <div class="mb-3">
