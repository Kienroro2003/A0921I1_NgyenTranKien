...
<div id="wp-featured-post">
    ...
    <div class="container justify-content-between">
        ...
        <div class="box featured-post">
            <div class="box-head">
                <a href="/customers" class="create" style="padding: 5px 10px;
                    background: #FF2C2B;
                    font-size: 20px;
                      color: white;
        ...
        <div class=" pt-20" style="width: 100%; ">
            ...
            <form action="/customers?action=edit" method="post">
                ...
                <div class="form-check">
                    ...
                    <label class="form-check-label" style="margin-left:20px" for="female">
                        Female
                    </label>
                </div>
                <div class="mb-3">
...
<%--                    <input type="text" class="form-control" name="salary" id="salary" placeholder="Enter salary" value="${customer.getCustomerSalary()}">--%>
<%--                </div>--%>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="address" id="address" placeholder="Enter address" value="${customer.getCustomerAddress()}">
                </div>
                <div class="mb-3">
                    <label for="customerType" class="form-label">Type</label>
                    <select class="form-select" name="customerTypeId" id="customerType" aria-label="Default select example" >
